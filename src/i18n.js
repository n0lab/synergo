const translations = {
  en: {
    ...
    nomenclatureExpandAll: 'Expand all',
    nomenclatureCollapseAll: 'Collapse all',
    nomenclatureExpand: (label) => `Expand ${label}`,
    nomenclatureCollapse: (label) => `Collapse ${label}`,
    nomenclatureAdd: 'Add',
  ...
  fr: {
    ...
    nomenclatureExpandAll: 'Tout déplier',
    nomenclatureCollapseAll: 'Tout replier',
    nomenclatureExpand: (label) => `Déplier ${label}`,
    nomenclatureCollapse: (label) => `Replier ${label}`,
