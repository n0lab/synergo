const translations = {
  en: {
    ...
    treeSubtitle: 'Visualize the parent/child relationships across nomenclatures.',
    treeNomenclatureTotal: (count) => `${count} saved nomenclatures`,
    treeNodeTotal: (count) => `${count} nodes in the graph`,
    treeEmpty: 'No nomenclature saved yet.',
  },
  fr: {
    sidebarOracle: 'Oracle',
    sidebarNomenclatures: 'Nomenclatures',
    ...
    treeSubtitle: 'Visualisez les relations parent/enfant entre vos nomenclatures.',
    treeNomenclatureTotal: (count) => `${count} nomenclatures enregistrées`,
    treeNodeTotal: (count) => `${count} nœuds dans le graphe`,
    treeEmpty: 'Aucune nomenclature enregistrée pour le moment.',
  },
};
